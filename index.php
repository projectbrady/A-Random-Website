...
<div class="main-container">
  ...
  <div class="form-wrapper">
    ...
    <form action="login_register.php" class="form <?= isActiveForm('login', $activeForm) ?>" id="login" method="post">
    ...
    <form action="login_register.php" class="form <?= isActiveForm('register', $activeForm) ?>" id="signup" method="post">
